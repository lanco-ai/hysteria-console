...
function CalibrationPanel({ calibration, onAction, busy, draft, setDraft }: { calibration: HealthCalibration; onAction: (action: string, fields?: Record<string, string>, confirmation?: string) => void; busy: boolean; draft: CalibrationDraft | null; setDraft: (draft: CalibrationDraft | null) => void }) {
...
export function HealthPanel({ calibrationDraft, setCalibrationDraft }: { calibrationDraft: CalibrationDraft | null; setCalibrationDraft: (draft: CalibrationDraft | null) => void }) {
  ...
  return <>
    ...
    {health.status === 'success' ? <div className="admin-page health-page">
      ...
      <CalibrationPanel calibration={health.data.calibration} onAction={(action, fields, confirmation) => void runAction(action, fields, confirmation)} busy={Boolean(actionBusy)} draft={calibrationDraft} setDraft={setCalibrationDraft}/>
