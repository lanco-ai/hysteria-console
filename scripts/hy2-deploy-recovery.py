...
EXACT_ALLOWED_PATHS = {
    ...
    "/etc/systemd/system/hysteria-react.service",
    ...
    "/root/hysteria/admin_config_routes.py",
    "/root/hysteria/admin_operations_routes.py",
    "/root/hysteria/user_views.py",
    "/root/hysteria/admin_views.py",
    "/root/hysteria/admin_overview_data.py",
    ...
    "/root/hysteria/overview_mutation_result.py",
    "/root/hysteria/traffic_mutation_service.py",
    "/root/hysteria/user_status_service.py",
    "/root/hysteria/billing_service.py",
    "/root/hysteria/authorization_service.py",
    "/root/hysteria/credential_service.py",
    "/root/hysteria/admin_credential_service.py",
    "/root/hysteria/user_deletion_service.py",
    "/root/hysteria/revocation_service.py",
    "/root/hysteria/identity_service.py",
    "/root/hysteria/landing_views.py",
    "/root/hysteria/shared_views.py",
    "/root/hysteria/health_presentation.py",
    "/root/hysteria/user_state_service.py",
    "/root/hysteria/operational_service.py",
    "/root/hysteria/audit_log.py",
    "/root/hysteria/user_panel_data.py",
    "/root/hysteria/public_page_routes.py",
    "/root/hysteria/user_panel_routes.py",
    "/root/hysteria/subscription_routes.py",
    "/root/hysteria/admin_console_routes.py",
    "/root/hysteria/landing_write_routes.py",
    "/root/hysteria/rule_pack_routes.py",
    "/root/hysteria/credential_routes.py",
    "/root/hysteria/auth_routes.py",
    "/root/hysteria/admin_traffic_routes.py",
    "/root/hysteria/admin_account_routes.py",
    "/root/hysteria/admin_user_status_routes.py",
    "/root/hysteria/admin_user_delete_routes.py",
    "/root/hysteria/user_compat.py",
    "/root/hysteria/display.py",
    "/root/hysteria/timeutil.py",
    "/root/hysteria/react_server.py",
    "/root/hysteria/panel/current",
    "/root/hysteria/web_api/__init__.py",
    "/root/hysteria/web_api/account_models.py",
    "/root/hysteria/web_api/account_routes.py",
    "/root/hysteria/web_api/agent_routes.py",
    "/root/hysteria/web_api/agent_rule_service.py",
    "/root/hysteria/web_api/agent_service.py",
    ...
    "/root/hysteria/web_api/health_models.py",
    "/root/hysteria/web_api/health_routes.py",
    "/root/hysteria/web_api/incident_models.py",
    "/root/hysteria/web_api/landing_models.py",
    "/root/hysteria/web_api/landing_routes.py",
    "/root/hysteria/web_api/models.py",
    "/root/hysteria/web_api/operation_models.py",
    "/root/hysteria/web_api/operation_routes.py",
    ...
    "/root/hysteria/web_api/service_probe.py",
    "/root/hysteria/web_api/services.py",
    "/root/hysteria/web_api/usage_models.py",
    "/root/hysteria/web_api/user_detail_models.py",
    "/root/hysteria/web_api/user_detail_routes.py",
    "/root/hysteria/web_api/user_models.py",
    "/root/hysteria/web_api/video_models.py",
    "/root/hysteria/web_api/video_provider.py",
    "/root/hysteria/web_api/video_routes.py",
