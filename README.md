...
- **Template config** — edit the shared Clash YAML template inline (JSON view, structural and syntax validation, format/collapse). Saves use file revisions; a stale draft receives HTTP 409 and retains its input.
